    ...
    <div class="card-body">
        ...
        <form action="<?php echo URLROOT; ?>/activities/create" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-10">
                ...
                <input type="date" name="act_startdate" class="form-control form-control-solid" required />
            </div>
            ...
            <div class="mb-10">
                ...
                <input type="time" name="act_starttime" class="form-control form-control-solid" required />
            </div>

            <div class="mb-10">
                <label for="endTime" class="required form-label">End Time</label>
                <input type="time" name="act_endtime" class="form-control form-control-solid" required />
            </div>

            <div class="mb-10">
                <label for="exampleFormControlInput1" class="required form-label">Venue </label>
                <input type="text" name="act_venue" class="form-control form-control-solid" placeholder="Venue" required />
            </div>
